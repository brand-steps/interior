...
const ManageListDisplay = () => {
  ...
  const [Delete , setdelete] = useState(false);
    const divStyle = {
      ...
      const getAllProducts = async () => {
        try {
          const response = await axios.get(`https://easy-erin-clownfish-ring.cyclic.app/listdisplay`);
  ...
  const BestData = async (id)=>{
    try {
      const response = await axios.get(`https://easy-erin-clownfish-ring.cyclic.app/bestlistingactive/${id}`)
      console.log("response: ", response.data);
  ...
  const DisapprovebestData = async (id)=>{
    try {
      const response = await axios.get(`https://easy-erin-clownfish-ring.cyclic.app/bestlisterdeactive/${id}`)
      console.log("response: ", response.data);
  ...
  const TopData = async (id)=>{
    try {
      const response = await axios.get(`https://easy-erin-clownfish-ring.cyclic.app/topsellingactive/${id}`)
      console.log("response: ", response.data);
  ...
  const DisapprovetopData = async (id)=>{
    try {
      const response = await axios.get(`https://easy-erin-clownfish-ring.cyclic.app/toplisterdeactive/${id}`)
      console.log("response: ", response.data);
