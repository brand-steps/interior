...
alert("Product Updated");
    ...
    return (
        ...
        <TextField fullWidth value={singleproduct.timer} onChange={handlecchange} placeholder='Edit timer' name="timer" variant="outlined" />
        ...
        <TextField fullWidth value={singleproduct.innerheight} onChange={handlecchange} placeholder='Edit product inner height' name="innerheight" variant="outlined" />
