...
console.log("img",imageUrl1)
    ...
    if (!imageUrl1 || imageUrl1.length === 0) {
    ...
    if (!imageUrl2 || imageUrl2.length === 0) {
      ...
      return;
    }    if (!imageUrl3 || imageUrl3.length === 0) {
      alert("image 3 required")
      return;
    }    if (!imageUrl4 || imageUrl4.length === 0) {
      alert("image 4 required")
      return;
    }    if (!imageUrl5 || imageUrl5.length === 0) {
      alert("image 5 required")
      return;
    }    if (!imageUrl6 || imageUrl6.length === 0) {
