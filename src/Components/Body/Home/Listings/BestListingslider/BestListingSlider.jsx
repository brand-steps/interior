...
const BestListingSlider = () => {
    ...
    const getAllProducts = async () => {
      try {
        const response = await axios.get(`https://quaint-pocketbook-bat.cyclic.app/listhotproduct`);
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="text-3xl font-bold text-gray-900 dark:text-white">Rs.{eachProduct.price}</span>
                  <button
...
export default BestListingSlider;
